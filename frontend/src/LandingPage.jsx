  ...
  return (
    <>
      <div className='w-full'>
        ...
        {/*Hero*/}
        <div className='min-w-full min-h-screen bg-[url(./images/mobile_bg.png)] md:bg-[url(./images/hero_background.png)] bg-center bg-cover bg-no-repeat py-25 px-30 flex flex-col'>
